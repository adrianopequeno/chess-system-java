...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {
		if (promoted == null)
			throw new IllegalStateException("Essa peça nao pode ser promovida!");
	...
	private Piece makeMove(Position source, Position target) {
		...
		p.increaseMoveCount();
		Piece capturedPiece = board.removePiece(target);// remove a possivel peça que esta na posicao de destino
		...
		if (capturedPiece != null) {
			...
			capturedPices.add(capturedPiece);// add a peça capturada na lista de peças capturadas
		}
